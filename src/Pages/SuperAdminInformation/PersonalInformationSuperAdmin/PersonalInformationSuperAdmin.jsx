...
import DataBaseSetting from "../../../../src/assets/images/images-SuperAdmin/Database Setting.png";
import DataBaseSetting2 from "../../../../src/assets/images/images-SuperAdmin/Database Setting(2).png";
...
export default function PersonalInformationSuperAdmin() {
      ...
      window.location.pathname === "/PersonalInformationSuperAdmin"
        ...
        : "hover:bg-gray-200 hover:text-[#0019BDD9]"
              ...
              <Link
                ...
                className="p-2 hover:bg-gray-200 hover:text-[#0019BDD9] rounded-md flex items-center gap-2 hover:cursor-pointer"
                onMouseEnter={(e) =>
                  (e.currentTarget.children[0].src = DataBaseSetting2)
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.children[0].src = DataBaseSetting)
                }
              >
                <img
                  src={DataBaseSetting}
